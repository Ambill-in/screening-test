...
// Fields where empty string '' should be converted to null
const NULLABLE_FIELDS = ['payment_mode', 'bank_account_id'] as const;

// Fields where '__none__' sentinel should be converted to null
const SENTINEL_FIELDS = ['bank_account_id'] as const;

// Sentinel value used by UI to indicate "no selection"
